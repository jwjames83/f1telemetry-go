...
Version: 1
*/
const CarStatusPacketSize = 1344

type carStatusDetails struct {
	...
	FuelRemainingLaps float  // Fuel remaining in terms of laps (value on MFD)
	...
	ERSStoreEnergy          float // ERS energy store in Joules
	ERSDeployMode           uint8 // ERS deployment mode, 0 = none, 1 = medium 2 = overtake, 3 = hotlap
	ERSHarvestedThisLapMGUK float // ERS energy harvested this lap by MGU-K
	ERSHarvestedThisLapMGUH float // ERS energy harvested this lap by MGU-H
	ERSDeployedThisLap      float // ERS energy deployed this lap
}

type CarStatus struct {
	CarStatus [MaxDrivers]carStatusDetails
}
