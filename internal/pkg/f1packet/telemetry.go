...
const CarTelemetryPacketSize int = 1307
...
type carTelemetryData struct {
	...
	TyresPressure           [4]float  // Tyres pressure (PSI)
	SurfaceType             [4]uint8  // Driving surface, see appendices
}

type CarTelemetry struct {
	CarTelemetryData [MaxDrivers]carTelemetryData
...
func (p *CarTelemetry) GetSize() int {
